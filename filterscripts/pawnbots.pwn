...
new 
	...
	gNick[MAX_NAME][25],
	gAdmin[MAX_ADMIN][25],
	gNickC[MAX_NAME char],
	gNickCplId[MAX_NAME] = {-1, ...};

new 
	playerLvl[MAX_PLAYERS],
	playerPing[MAX_PLAYERS],
	playerColor[MAX_PLAYERS],
	playerPBot[MAX_PLAYERS],
	playerNick[MAX_PLAYERS][25],
	playerSetList[MAX_PLAYERS char],
	playerRakNetScore[MAX_PLAYERS],
	playerRakNetPing[MAX_PLAYERS];
